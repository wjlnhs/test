...
//        },/// 交易账号
    ...
    var saveCompanyFourthStep=function(isValid,step,isDraft){
        ...
        var modelUpload={
            modelpair:[{
                key:'MaximumContractUrl',
                text:'近一年最大金额的一份合同'
            },{
                key:'RecentContractUrl',
                text:'最近签订的一份企业合同'
            },{
                key:'PerformanceContractUrl',
                text:'履行中合同金额统计表'
            }],
            modelpairMult:[{
                key:'BusinessPremisesCertificateUrl',
                text:'经营场所证明（租赁合同或房产证明）'
            }]
        }
        getModelAndSave(modelUpload,isValid,step,isDraft);
    }
    ...
    var saveCompanySixthStep=function(isValid,step,isDraft){
        ...
        var modelUpload={
            ...
            modelpairMult:[{
                key:'HydropowerCoalUrl',
                text:'最近三个月缴纳水、电、煤气账单'
            },{
                key:'PropertyCertificateUrl',
                text:'法人个人财产证明'
            }]
        }
        getModelAndSave(modelUpload,isValid,step,isDraft);
                ...
                for(var j in uploadsMult){
                    if(!uploadsMult[j]){
                        ...
                        if(!$.isEmptyObject(obj)){
                            ...
                            uploadsMult[j].setOption('onExistDelete',function(){
                                alert(888888)
                            })
                        }else{
