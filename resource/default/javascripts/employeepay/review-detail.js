...
define(function (require, exports,modules) {
    ...
    var openWindow=function(type,val){
         var showbox=$(i8ui.showbox({title:'请填写审批意见',cont:template('openwindow',{val:val})}));
        showbox.on('click','.sure',function(){
            var approveNote=$('#approveNote');
            approve(applyid,type,approveNote.val()||approveNote.attr('placeholder')||'',function(data){
