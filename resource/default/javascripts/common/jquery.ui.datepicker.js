	...
	_generateHTML: function(inst) {
		...
		for (var row = 0; row < numMonths[0]; row++) {
			...
			for (var col = 0; col < numMonths[1]; col++) {
                ...
                thead+='<th class="calendar-first">&nbsp;</th>'
				...
				for (var dRow = 0; dRow < numRows; dRow++) { // create date picker rows
					calender += '<tr >';
                    calender+='<td class="weekdailypng-bg all"></td>'
					...
					for (var dow = 0; dow < 7; dow++) { // create date picker days
						...
						tbody += '<td class="' +
							...
							(unselectable ? '<span class="ui-state-default">' + printDate.getDate() + '</span>' : '<a class="ui-state-default weekdailypng-bg paysubmit' +
