<div class="new-folder-cont i8-form" style="width: 575px">
    <dl>
        <dt class="rel"><i class="icon-required">*</i>名称</dt>
        <dd><input  class="foldername" /></dd>
        <dt class="rel"><i class="icon-required">*</i>上级文件夹</dt>
        <dd>
        ...
        <dt class="powerhide rel"><i class="icon-required inherit-checkbox">*</i>权限</dt>
        <dd class="powerhide"><span class="app-checkbox v--4 m-r15 checked inherit-checkbox"></span>和所在文件夹权限保持一致</dd>
    </dl>
    <div class="app-table-list l-h40 powertable powerhide">
        <table>
            <thead>
            <tr>
                <td class="w-200">用户
        ...
        <a href="javascript:void(0)" class="longadd"><i class="icon icon-white-add"></i>&nbsp;添加</a>
    </div>
</div>
